...
namespace ly
{
    ...
    void GxCamera::setAAROIParam(int64_t Width, int64_t Height, int64_t OffsetX, int64_t OffsetY)
    {
    ...
    void GxCamera::setWhiteBalanceParam(bool WhiteBalanceOn, float BalanceRatioRed, float BalanceRatioBlue, float BalanceRatioGreen, GX_AWB_LAMP_HOUSE_ENTRY lightSource)
    {
        //自动白平衡光照环境
